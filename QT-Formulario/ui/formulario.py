...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QIcon()
        icon.addFile(u":/images/images/cancel.png", QSize(), QIcon.Normal, QIcon.Off)
        self.actionClose.setIcon(icon)
        self.actionReloaded = QAction(MainWindow)
        self.actionReloaded.setObjectName(u"actionReloaded")
        icon1 = QIcon()
        icon1.addFile(u":/images/images/upgrande.png", QSize(), QIcon.Normal, QIcon.Off)
        self.actionReloaded.setIcon(icon1)
        ...
        icon2 = QIcon()
        icon2.addFile(u":/images/images/check.png", QSize(), QIcon.Normal, QIcon.Off)
