# Python Tkinter Build a Geography Flashcard I
...
root = Tk()
root.title('Python Tkinter Build a Geography Flashcard I')
root.iconbitmap('Python Tkinter Build a Geography Flashcard I/avatar.ico')
