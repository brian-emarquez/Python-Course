...
root = Tk()
root.title('Python Tkinter Multiple CRM search Results!')
root.iconbitmap('Python Tkinter Multiple CRM search Results/db.ico')
...
def write_to_csv(result):
    with open('Python Tkinter Multiple CRM search Results/customers.csv', 'a') as f:
...
def search_customer():
    ...
    search_customers.iconbitmap('Python Tkinter Multiple CRM search Results/db.ico')
...
def list_customer():
    ...
    list_customer_query.iconbitmap('Python Tkinter Multiple CRM search Results/db.ico')
