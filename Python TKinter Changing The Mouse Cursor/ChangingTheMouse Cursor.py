...
root = Tk()
root.title('Python TKinter Changing The Mouse Cursor')
root.geometry("500x550")
root.iconbitmap('Python TKinter Changing The Mouse Cursor/icons/elvis.ico')
...
for cursor in list:
    if count < 5:
        ...
        Button(root, text=cursor, cursor=cursor, width=10, height=5, fg="darkblue").grid(row=row4, column=3, pady=5, padx=5)
        row4 +=1
        count +=1
