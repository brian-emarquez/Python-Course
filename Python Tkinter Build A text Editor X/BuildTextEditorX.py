# Python Tkinter Build A text Editor VX - Night Mode
...
def open_file():
    ...
    # Grab Filename
    text_file = filedialog.askopenfilename(initialdir="Python Tkinter Build A text Editor X/documents/", title="Open File", filetypes=(("Text Files", "*.txt"), ("HTML Files", "*.html"), ("Python Files", "*.py"), ("All Files", "*.*")))
    ...
    name = name.replace("C:/Users/brian/Documents/Python-Course/Python Tkinter Build A text Editor X/documents/", "")
...
#Save as file
def save_as_file():
    text_file = filedialog.asksaveasfilename(defaultextension=".*", initialdir="C:/Users/brian/Documents/Python-Course/Python Tkinter Build A text Editor X/documents/", title="Save File", filetypes=(("Text Files", "*.txt"), ("HTML Files", "*.html"), ("Python Files", "*.py"), ("All Files", "*.*")))
    if text_file:
        # Updates Status Bars
        name = text_file
        status_bar.config(text=f'{name}         ')
...
def print_file():
    ...
    file_to_print = filedialog.asksaveasfilename(defaultextension=".*", initialdir="C:/Users/brian/Documents/Python-Course/Python Tkinter Build A text Editor X/documents/", title="Save File", filetypes=(("Text Files", "*.txt"), ("HTML Files", "*.html"), ("Python Files", "*.py"), ("All Files", "*.*")))
