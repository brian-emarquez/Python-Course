# Aplicacion Grafica Guiada VI
# Aplicacion Grafica CRUD
# Borrar Registros
# Calsultas Parametrizadas
...
# -------------------- Funciones--------------------
def conexionBBDD():
    miConexion=sqlite3.connect("Practica Guiada VI/Usuarios")
...
def leer():
    ...
    elUsuario=miCursor.fetchall() #devuelve un array 
