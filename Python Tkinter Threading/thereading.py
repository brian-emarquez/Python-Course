...
root.title('Learn To Code at Python Python Tkinter Threading')
root.iconbitmap('Python Tkinter Threading/panda.ico')
...
threading.Thread(target=five_seconds).start() # mostr el mensaje automaticamente
